...
module RBACApiClient
  class AccessApi
    ...
    # @return [Array<(OneOfAccessNoPaginationAccessPagination, Integer, Hash)>] OneOfAccessNoPaginationAccessPagination data, response status code and response headers
    def get_principal_access_with_http_info(application, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'OneOfAccessNoPaginationAccessPagination' 
